...
const QMetaObject ConfigHandler::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_ConfigHandler.data,
      qt_meta_data_ConfigHandler,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *ConfigHandler::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ConfigHandler.stringdata0))
        return static_cast<void*>(const_cast< ConfigHandler*>(this));
