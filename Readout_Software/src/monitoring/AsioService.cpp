...
int CAsioService::AsioServiceCounter = 0;
...
m_stopping(false)
{
   ...
   CAsioService::AsioServiceCounter += 1;

//   std::cout << "CAsioService::AsioServiceCounter = " << CAsioService::AsioServiceCounter  << std::endl;
...
CAsioService::~CAsioService()
{
//   std::cout << " +++ CAsioService ends (a)+++" << std::endl;

   m_io_service.stop();
   m_thread_group.join_all();
//      std::cout << " +++ CAsioService ends (b)+++" << std::endl;
   CAsioService::AsioServiceCounter -= 1;
//   std::cout << "CAsioService::AsioServiceCounter = " << CAsioService::AsioServiceCounter  << std::endl;
...
{
   std::cout << " +++ CAsioService handle stop ====" << std::endl;
   m_stopping = true;
}
...
void CAsioService::reset()
{
   m_io_service.reset();
}

void CAsioService::join_all()
{
   m_thread_group.join_all();
}
